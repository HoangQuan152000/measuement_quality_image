...
public:
    ...
    std::vector<std::pair<EResult, float>> mCathode2Anode = {};
    std::vector<std::pair<EResult, float>> mAnode2Case = {};
    std::vector<std::pair<EResult, float>> mCathode2Case = {};
    VecDouble mXPoles = {};
...
{
public:
    explicit BatteryInspectorPole(float const &pxSize) : PixelRef{pxSize}
    {
    }
    explicit BatteryInspectorPole(float &&pxSize) = delete;
