...
XVT_LIB_EXPORTS std::vector<cv::Point> rotate180vtPoint(const std::vector<cv::Point> &vtP_In, cv::Point center);

XVT_LIB_EXPORTS cv::Point rotate180Point(const cv::Point &pntIn, cv::Point center);
