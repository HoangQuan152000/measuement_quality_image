...
inline bool CompareArea(std::vector<cv::Point> const& lhs, std::vector<cv::Point> const& rhs)
{
    return (cv::contourArea(lhs) < cv::contourArea(rhs));
}

inline bool CompareHeight(std::vector<cv::Point> const& lhs, std::vector<cv::Point> const& rhs)
{
    return (cv::boundingRect(lhs).height < cv::boundingRect(rhs).height);
}

inline bool CompareWidth(std::vector<cv::Point> const& lhs, std::vector<cv::Point> const& rhs)
{
